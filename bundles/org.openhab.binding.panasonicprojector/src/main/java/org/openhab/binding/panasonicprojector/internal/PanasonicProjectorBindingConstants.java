...
/**
 * The {@link PanasonicProjectorBindingConstants} class defines common constants, which are
 * used across the whole binding.
 *
 * @author Michael Lobstein - Initial contribution
 */
@NonNullByDefault
public class PanasonicProjectorBindingConstants {

    private static final String BINDING_ID = "panasonicprojector";
