 ...
 */
@NonNullByDefault
public class PanasonicProjectorTcpConnector implements PanasonicProjectorConnector {

    private final Logger logger = LoggerFactory.getLogger(PanasonicProjectorTcpConnector.class);
    ...
    public PanasonicProjectorTcpConnector(String ip, int port) {
        this.ip = ip;
        this.port = port;
    }
