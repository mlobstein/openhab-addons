 ...
 */
@NonNullByDefault
public class PanasonicProjectorSerialConnector implements PanasonicProjectorConnector, SerialPortEventListener {

    private final Logger logger = LoggerFactory.getLogger(PanasonicProjectorSerialConnector.class);
    ...
    public PanasonicProjectorSerialConnector(SerialPortManager serialPortManager, String serialPort) {
    ...
    public void connect() throws PanasonicProjectorException {
        try {
            ...
            throw new PanasonicProjectorException(e);
        }
    }
    ...
    @Override
    public String sendMessage(String data, int timeout) throws PanasonicProjectorException {
        InputStream in = this.in;
        OutputStream out = this.out;
    ...
    private String sendMmsg(String data, int timeout) throws IOException, PanasonicProjectorException {
        String resp = "";
            ...
            while (elapsedTime < timeout) {
                ...
                if (availableBytes > 0) {
                    ...
                    if (resp.contains(ETX)) {
                        return resp.replace(STX, "").replace(ETX, "");
                    }
                } else {
                    try {
                        Thread.sleep(100);
