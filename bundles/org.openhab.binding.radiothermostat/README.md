...
|------------------------|----------------------|--------|-----------------------------------------------------------------------------------------------------------------------------------------|
| temperature            | Number:Temperature   | R      | The current temperature reading (°F) of the thermostat                                                                                  |
| humidity               | Number:Dimensionless | R      | The current humidity reading of the thermostat (CT80 only)                                                                              |
| mode                   | Number               | RW     | The current operating mode of the HVAC system                                                                                           |
| fan_mode               | Number               | RW     | The current operating mode of the fan                                                                                                   |
| program_mode           | Number               | RW     | The program schedule that the thermostat is running (CT80 Rev B only)                                                                   |
| set_point              | Number:Temperature   | RW     | The current temperature set point (°F) of the thermostat                                                                                |
| status                 | Number               | R      | Indicates the current running status of the HVAC system                                                                                 |
| fan_status             | Number               | R      | Indicates the current fan status of the HVAC system                                                                                     |
| override               | Number               | R      | Indicates if the normal program set-point has been manually overridden                                                                  |
| hold                   | Switch               | RW     | Indicates if the current set point temperature is to be held indefinitely                                                               |
| remote_temp            | Number:Temperature   | W      | Override the internal temperature (°F) as read by the thermostat's temperature sensor; Set to -1 to return to internal temperature mode |
| day                    | Number               | R      | The current day of the week reported by the thermostat (0 = Monday)                                                                     |
| hour                   | Number               | R      | The current hour of the day reported by the thermostat (24 hr)                                                                          |
| minute                 | Number               | R      | The current minute past the hour reported by the thermostat                                                                             |
| dt_stamp               | String               | R      | The current day of the week and time reported by the thermostat (E HH:mm)                                                               |
| today_heat_runtime     | Number:Time          | R      | The total number of minutes of heating run-time today                                                                                   |
| today_cool_runtime     | Number:Time          | R      | The total number of minutes of cooling run-time today                                                                                   |
| yesterday_heat_runtime | Number:Time          | R      | The total number of minutes of heating run-time yesterday                                                                               |
| yesterday_cool_runtime | Number:Time          | R      | The total number of minutes of cooling run-time yesterday                                                                               |
| message                | String               | W      | Used to display a number in the upper left 'price message' area of the thermostat's screen where the time is normally displayed         |
| next_temp              | Number:Temperature   | R      | Displays the next scheduled thermostat set point temperature in the heating or cooling schedule                                         |
| next_time              | DateTime             | R      | Displays the next scheduled thermostat set point time in the heating or cooling schedule                                                |
